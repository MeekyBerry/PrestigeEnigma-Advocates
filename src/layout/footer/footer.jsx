    ...
    <footer className={style.footer}>
      <div className={style.top}>
        <figure className={footerStyle.figure}>
          ...
          <figcaption className={footerStyle.caption}>
            <h1 className={footerStyle.title}>Joel Catty Legal</h1>
        ...
        <p className={style.para}>
          Joel Catty Legal was built on the idea that sophisticated legal
          services should be convenient, modern and affordable. State-of-the-art
          practice technology allows us to serve our clients efficiently. We put
          our clients first and achieve tremendous results. Experience how law
          can be done better.
        </p>
      </div>
        ...
        <div className={style.contact}>
          ...
          <div className={style.box}>
            ...
            <p className={style.boxPara}>
              <a
                href="https://goo.gl/maps/rzUJqgT3r4n6PEE69"
                target="_blank"
                rel="noreferrer"
              >
                415 12th Ave SW, Olympia, WA 98504, USA
              </a>
            </p>
          </div>
        </div>
      ...
      <div className={style.wrapper}>
        <div className={style.header}>
          ...
          <h3>Quickly navigate our site through our sitemap below!</h3>
        </div>
      ...
      <p className={style.copyright}>
        <span>© 2021 Joel Catty Legal. All Rights Reserved.</span>
        <span>Powered by Joel Catty Legal.</span>
      </p>
    </footer>
  );
};
